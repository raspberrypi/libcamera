...
int32_t IpaVc4::init(const IPASettings &settings, const InitParams &params, InitResult *result)
{
...
int IpaVc4::configure(const IPACameraSensorInfo &sensorInfo, const ConfigParams &params,
		      ConfigResult *result)
{
...
void IpaVc4::prepareIsp([[maybe_unused]] const PrepareParams &params,
...
RPiController::StatisticsPtr IpaVc4::processStats(Span<uint8_t> mem)
{
